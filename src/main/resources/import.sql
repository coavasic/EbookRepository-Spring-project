...
insert into users(firs_name,last_name,user_name,password,role) values ("Aleksandar","Vasic","admin","$2a$04$nyiE./uZUvZePs5SMlPjS.FAiHKVinZW46fYbrXWt5cHTMTc3tx2e","admin")